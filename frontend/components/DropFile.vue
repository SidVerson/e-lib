...
const props = withDefaults(
    ...
    {
      title: "Перетащите сюда файл или нажмите чтобы выбрать его в файлах" ,
      subtext: "Формат pdf",
...
const styles = cva(   "flex w-full cursor-pointer items-center justify-center rounded-md border border-dashed transition hover:border-primary",
    {
  variants: {
